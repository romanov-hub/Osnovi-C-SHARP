...
namespace Дроби
{
    ...
    internal class Fraction
    {
        ...
        internal Fraction Division(Fraction fraction2)
        {
            throw new NotImplementedException();
        }

        internal Fraction Minus(Fraction fraction2)
        {
            throw new NotImplementedException();
        }

        internal Fraction Multi(Fraction fraction2)
        {
            throw new NotImplementedException();
        }

        internal Fraction Plus(Fraction fraction2)
        {
            throw new NotImplementedException();
        }

        internal void Simplification()
        {
            throw new NotImplementedException();
        }
    }
